...
public class MPSolverParameters {
  ...
  public static PresolveValues getKDefaultPresolve() {
    return PresolveValues.swigToEnum(main_research_linear_solverJNI.MPSolverParameters_kDefaultPresolve_get());
  }

  public static IncrementalityValues getKDefaultIncrementality() {
    return IncrementalityValues.swigToEnum(main_research_linear_solverJNI.MPSolverParameters_kDefaultIncrementality_get());
  }
