...
public class RoutingModel {
  ...
  public void AddTemporalRequiredTypeAlternatives(int dependent_type, SWIGTYPE_p_absl__flat_hash_setT_int_t required_type_alternatives) {
    mainJNI.RoutingModel_AddTemporalRequiredTypeAlternatives(swigCPtr, this, dependent_type, SWIGTYPE_p_absl__flat_hash_setT_int_t.getCPtr(required_type_alternatives));
  }

  public SWIGTYPE_p_std__vectorT_absl__flat_hash_setT_int_t_t GetTemporalRequiredTypeAlternativesOfType(int type) {
    return new SWIGTYPE_p_std__vectorT_absl__flat_hash_setT_int_t_t(mainJNI.RoutingModel_GetTemporalRequiredTypeAlternativesOfType(swigCPtr, this, type), false);
  }
  ...
  public boolean HasTypeRegulations() {
    return mainJNI.RoutingModel_HasTypeRegulations(swigCPtr, this);
  }
  ...
  public Assignment PackCumulsOfGlobalOptimizerDimensionsFromAssignment(Assignment original_assignment, SWIGTYPE_p_absl__Duration duration_limit) {
    long cPtr = mainJNI.RoutingModel_PackCumulsOfGlobalOptimizerDimensionsFromAssignment(swigCPtr, this, Assignment.getCPtr(original_assignment), original_assignment, SWIGTYPE_p_absl__Duration.getCPtr(duration_limit));
    return (cPtr == 0) ? null : new Assignment(cPtr, false);
  }
  ...
  public SWIGTYPE_p_absl__Duration RemainingTime() {
    return new SWIGTYPE_p_absl__Duration(mainJNI.RoutingModel_RemainingTime(swigCPtr, this), true);
  }
